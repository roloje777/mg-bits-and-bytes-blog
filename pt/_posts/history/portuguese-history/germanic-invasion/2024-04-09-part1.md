...
<container>
    <h4>O fim do Império Romano na Hispânia.(409-411 d.C.)</h4>
     <p>
         ...
         No fim de semana, o Império Romano não podia se dar ao luxo de enviar legiões para lutar nestas regiões.<br>
...
<container>
    <h4>Os Suevos</h4> 
        ...
        <div>
          ...
          <div>
            <img style="display:block;margin-left:auto;margin-right:auto;border:solid 1px" src="https://www.historicmysteries.com/wp-content/uploads/2023/11/village.jpg">
            <p style="text-align:center">Suevos</p>
         </div>
                   <div>
            <img style="display:block;margin-left:auto;margin-right:auto;border:solid 1px" src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Top%C3%B3nimos_germ%C3%A2nicos_em_Portugal.png/220px-Top%C3%B3nimos_germ%C3%A2nicos_em_Portugal.png">
            <p style="text-align:center">Cidades com topónimos germânicos em Portugal</p>
         </div>
<details>
    <summary>
...
<container>
  <h4>Leiria - Portugal</h4>
      <div
      style="position: relative; padding-bottom: 56.25%; padding-top: 35px; height: 0; margin-bottom: 2em; overflow: hidden; ">
      <iframe     style="position: absolute; top: 0; left: 0; width: 100%; height: 100%"
        src="https://www.youtube.com/embed/C1Isv3A0IrY?si=h7yS29XFHYV29vVn"
        title="YouTube video player" allowfullscreen >
      </iframe>
    </div>
<p style="position: relative; text-align: center">Região de Leiria - Região de Maravilhas</p>
   <p>
   O nome Leiria deriva de “leira”, significando zona com pequenos vasos agrícolas do período medieval galego-português.<br>
   Leiria é habitada há séculos, tendo sido ocupada pela primeira vez pelos Suevos em 414, até serem expulsos pelos Romanos.<br>
