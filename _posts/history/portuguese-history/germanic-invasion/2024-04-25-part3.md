...
<div>
    ...
    <details>
        <summary><i>"Did you know you should rather drink that with a<span class="my-p"> bit of sugar!!,</span></i> I though to myself.<br>
    Having just woken up, and a little older and a little bit wiser, I usually know  when to bite my tongue😂🤣<br>, ... so I finish my cup and grab the laptop to start working on this blog.<br>
        ...
        <div class="center" style="width:50%">        
          <img class="center" src="https://upload.wikimedia.org/wikipedia/commons/d/d3/A_BRASILEIRA_DO_CHIADO.jpg" alt="Café A Brasileira (Lisboa)">
          <p style="text-align:center">Café A Brasileira (Lisboa)</p>
        </div>
        <p>
        It was in Brasileira do Chiado (Lisbon Portugal) that the term «bica» was born, which would be, among the various existing versions, the abbreviation for "beba isso com açúcar“ (drink this with sugar), an incentive to make coffee (a novelty at the time), more pleasant for customers , while they created the habit and scheduled a ritual.</br>
        Another version says that the name would come from the fact that the coffee was served directly into cups from the taps (or "spouts") of the machines where it was made, because customers considered that the intermediate passage to the coffee maker caused it to lose flavor, having the The term was adopted as a synonym for coffee, to this day.<br>
...
<div>
    ...
    <div class="center" style="width:80%">
        <img class="center" src="https://www.thoughtco.com/thmb/92D08EwUT9mL4RlWobUf7YiYPAM=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/GettyImages-707706935-59ac34e09abed50011ffdeb8.jpg" alt="">
        <p style="text-align:center">395 BC Visigoth King Alaric by By Robert Wilde</p>
    </div>
    <p>
...
<details>
    ...
    <framed-text>
    <div class="center" style="width:80%">
    <img class="center" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Celts_in_III_century_BC.jpg/280px-Celts_in_III_century_BC.jpg" alt="Gaul">
    <p style="text-align:center">Gaul</p>
    </div>
...
<div>
    ...
    <div class="center" style="width:80%">
        <img class="center" src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Eurico%2C_rey_de_los_Visigodos_%28Museo_del_Prado%29.jpg/800px-Eurico%2C_rey_de_los_Visigodos_%28Museo_del_Prado%29.jpg" alt="Imaginary portrait of Euric by Manuel Rodríguez de Guzmán. Oil on canvas (1855)">
        <p style="text-align:center">Imaginary portrait of Euric by Manuel Rodríguez de Guzmán. Oil on canvas (1855)</p>
    </div>
    <p>
    <div class="center" style="width:60%">
      <img class="center" style="object-fit:fill;width:100%;border:solid"  src="https://lh4.googleusercontent.com/proxy/f3C0Ib5VkAE_zUvFa_gdrASnjxo7c9PO7cdcNGuGG0SVN3JBC-KCpiz0f8BmdQNEODuLZansSrgV-uQOkT3xbA" alt="Map of Baetica and Lusitania 1st Century AD">  
      <p style="text-align:center">Map of Baetica and Lusitania 1st Century AD</p>  
    </div>     
...
<div>
    ...
    <details>
        ...
        <div class="center" style="width:80%">
            <img class="center" src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Gold_Solidus_of_Romulus_Augustulus.jpg/220px-Gold_Solidus_of_Romulus_Augustulus.jpg" alt="Solidus of Romulus Augustus, marked:
dn romvlvs avgvstvs p f avg">
            <p style="text-align:center">Solidus of Romulus Augustus, marked:
dn romvlvs avgvstvs p f avg</p>
        </div>
        ...
        <h4>Odoacer</h4>
            <div class="center" style="width:80%">
            <img class="center" src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Romulus_Augustulus_and_Odoacer.jpg/220px-Romulus_Augustulus_and_Odoacer.jpg" alt="Romulus Augustus resigns the Crown (from a 19th-century illustration).">
            <p style="text-align:center">Romulus Augustus resigns the Crown (from a 19th-century illustration).</p>
            </div>   
  ...
  <!--<div style="display:flex;justify-content:start;margin: 1em"> -->
  <div>
        <div class="center" style="width:60%">
        <img class="center" style="object-fit:fill;width:100%;border:solid" src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Andalucia_in_Spain_%28including_Canarias%29_%28special_marker%29.svg/275px-Andalucia_in_Spain_%28including_Canarias%29_%28special_marker%29.svg.png" alt="Map of Spain with Andalusia highlighted">
        <p style="text-align:center">Map of Spain with Andalusia highlighted</p>
      </div>
   <unframed-text>
...
<div>   
    <div style="display:flex;justify-content:start">        
        <div style="width:30%">
        <img class="center" style="object-fit:cover" src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/Leovigildo_01.jpg/220px-Leovigildo_01.jpg" alt="Statue of Liuvigild in Madrid (Felipe del Corral), 1750-53">
        <p style="text-align:center">Statue of Liuvigild in Madrid (Felipe del Corral), 1750-53</p>
        </div>
        <details>         
            <summary>
...
<div>
    <div style="display:flex;justify-content:start">        
        <div style="width:30%">
        <img class="center" style="object-fit:cover" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9d/Reccaredo-1.jpg/220px-Reccaredo-1.jpg" alt="Imaginary portrait of Reccared I by an unknown artist. dated between 1312-1325">
